...
import com.example.vacunacionshark.actividades.LoginActivity;
import com.example.vacunacionshark.sqlite.Sesion;
...
public class ConfiguracionFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        jbtn_cerrar_sesion = vista.findViewById(R.id.cfg_btn_cerrarSesion);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.cfg_btn_cerrarSesion:
                cerrar_sesion();
                break;
        }
    }
